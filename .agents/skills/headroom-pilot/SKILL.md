---
name: headroom-pilot
description: Define the controlled Headroom context-compression pilot for FrankiFlow. Use only for large, repetitive context where exact raw source is not the primary safety boundary.
---

# Headroom Pilot — FrankiFlow
...
pricing arithmetic, Supabase authorization/RLS assumptions, migrations, exact calculator contracts, legal copy, or security-sensitive code.
